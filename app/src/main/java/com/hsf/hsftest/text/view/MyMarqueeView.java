...
public class MyMarqueeView extends LinearLayout {
    ...
    private void prepareAnimation() {
        ...
        if (BuildConfig.DEBUG) {
            Log.d(TAG, "prepareAnimation called ");
            Log.d(TAG, "stringOfTextView: " + stringOfTextView + "###");
            Log.d(TAG, "widthOfTextView: " + widthOfString);
            Log.d(TAG, "widthOfMarqueeView: " + widthOfMarqueeView);
