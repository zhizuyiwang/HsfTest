 ...
 *
 *@创建日期 2017/9/5 19:03
 * 两端对齐的TextView，可以设置最后一行靠左、靠右或居中对齐
 */
...
public class AlignTextView extends android.support.v7.widget.AppCompatTextView {
     ...
     */
    public enum Align {
        ALIGN_LEFT, ALIGN_CENTER, ALIGN_RIGHT  //居中、居左或居右，针对段落最后一行
    }
    ...
    public AlignTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
        lineSpacingMultiplier = attrs.getAttributeFloatValue("http://schemas.android" + "" + ".com/apk/res/android", "lineSpacingMultiplier", 1.0f);
     ...
     * @Description 获取文本实际所占高度，辅助用于计算行高、行数
     */
