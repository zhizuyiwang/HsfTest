...
import com.hsf.hsftest.design.recycler.stickheader.bean.StickyExampleModel;
...
public class StickyExampleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context).inflate(R.layout.layout_sticky1_list_item, parent, false);
