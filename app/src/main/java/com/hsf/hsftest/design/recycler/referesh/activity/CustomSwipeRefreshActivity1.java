...
import com.hsf.hsftest.design.recycler.referesh.footerView.SwipeRecyclerView;
 ...
 *@作者 hsf
 *
 *@创建日期 2017/9/19 15:17
 * http://www.jianshu.com/p/d7fe9b952d26
 */
public class CustomSwipeRefreshActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_swipe_refresh1);
        recyclerView = (SwipeRecyclerView) findViewById(R.id.swipe_recycler_view);
    ...
    private class RecyclerViewAdapter extends RecyclerView.Adapter<ItemViewHolder> {
        ...
        public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(CustomSwipeRefreshActivity1.this).inflate(R.layout.demo_layout_item, parent, false);
        ...
        public void onBindViewHolder(final ItemViewHolder holder, final int position) {
            ...
            holder.tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(CustomSwipeRefreshActivity1.this, "快来咬我啊，我是" + position + "号", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
