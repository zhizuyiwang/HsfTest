...
import com.hsf.hsftest.design.recycler.referesh.listener.LoadDataScrollController;

public class CustomSwipeRefreshActivity3 extends AppCompatActivity implements  LoadDataScrollController.OnRecycleRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_swipe_refresh3);
