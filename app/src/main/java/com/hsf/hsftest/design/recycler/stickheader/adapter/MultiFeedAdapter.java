package com.hsf.hsftest.design.recycler.stickheader.adapter;
...
public class MultiFeedAdapter extends RecyclerView.Adapter {
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    if (viewType == TYPE_TIME) {
      itemView =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sticky_time, parent, false);
      return new TimeHolder(itemView);
    } else {
      itemView =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sticky_feed, parent, false);
