...
import com.hsf.hsftest.design.recycler.referesh.adapter.BaseRecyclerViewAdapter;
import com.hsf.hsftest.design.recycler.referesh.custom.SRecyclerView;
import com.hsf.hsftest.design.recycler.referesh.listener.OnItemClickLisener;
import com.hsf.hsftest.design.recycler.referesh.listener.OnRecyclerStatusChangeListener;
 ...
 *@作者 hsf
 *
 *@创建日期 2017/9/29 10:54
 * http://blog.csdn.net/u014674558/article/details/52549101
 */

public class CustomRecyclerViewActivity3 extends AppCompatActivity implements OnRecyclerStatusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_recycler_view3);
    ...
    class MyAdapter extends BaseRecyclerViewAdapter<MyAdapter.ViewHolder> {
        ...
        public View getItemView(int viewType, ViewGroup parent) {
            return new TextView(CustomRecyclerViewActivity3.this);
        }
