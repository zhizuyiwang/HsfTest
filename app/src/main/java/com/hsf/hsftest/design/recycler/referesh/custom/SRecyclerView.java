...
import com.hsf.hsftest.design.recycler.referesh.view.ElizabethView;
import com.hsf.hsftest.design.recycler.referesh.view.FruitView;
...
public class SRecyclerView extends ViewGroup {
    ...
    void init(Context context,AttributeSet attrs) {
        ...
        type = a.getInt(R.styleable.SRecyclerView_mode, TYPE_LIST);
        a.recycle();
        mScroller = new Scroller(context);
        switch (type){
            case 0:
