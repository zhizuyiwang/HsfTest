...
import com.hsf.hsftest.util.utils.ToastUtil;
import com.hsf.hsftest.util.utils.UIUtils;
import com.hsf.hsftest.weight.RoundImageView;
import com.hsf.hsftest.weight.TitleView;

import java.util.Random;

public class CustomDrawerCardActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_drawer_card1);
        initView();
        setListener();
        addCard(6);
    }
