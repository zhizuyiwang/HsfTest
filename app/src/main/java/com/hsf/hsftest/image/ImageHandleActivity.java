...
import com.hsf.hsftest.image.banner.BannerActivity;
...
import com.hsf.hsftest.image.photo.TakePhotoAndCropActivity;
import com.hsf.hsftest.image.scalelayout.scaleViewPager.ScaleViewPagerActivity;
import com.hsf.hsftest.image.scrollview.PullToZoomActivity;
import com.hsf.hsftest.image.selector.ImageSelectorActivity;
...
public class ImageHandleActivity extends AppCompatActivity {
    ...
    TextView tvBanner;
    @BindView(R.id.tv_image_selector)
    ...
    @OnClick({R.id.tv_take_photo, R.id.tv_image_pull_to_zoom, R.id.tv_circle_image,
            R.id.tv_big_picture, R.id.tv_view_flipper, R.id.tv_view_preview, R.id.tv_scale_layout,
            R.id.tv_drawable, R.id.tv_banner,R.id.tv_image_selector})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_take_photo:
                startActivity(new Intent(this, TakePhotoAndCropActivity.class));
                break;
            case R.id.tv_image_selector:
