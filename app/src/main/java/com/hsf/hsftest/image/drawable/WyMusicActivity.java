 ...
 *@作者 hsf
 *
 *@创建日期 2017/9/21 15:10
 *
 * http://www.jianshu.com/p/0e0de2cdd2bb
 */

public class WyMusicActivity extends AppCompatActivity implements View.OnClickListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener{
    ...
    private static final String MUS_DIR = "musics";

    private String names[] = {MUS_DIR +"/demo01.mp3", MUS_DIR + "/demo02.mp3"};
    private int position = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wy_music);
