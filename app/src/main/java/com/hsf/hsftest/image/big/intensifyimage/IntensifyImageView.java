package com.hsf.hsftest.image.big.intensifyimage;
...
public class IntensifyImageView extends View implements IntensifyImage,
    ...
    protected void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IntensifyImageView,defStyleAttr, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        List<IntensifyImageDelegate.ImageDrawable> drawables = mDelegate.obtainImageDrawables(mDrawingRect);

        int save = canvas.save();
        int i = 0;
        for (IntensifyImageDelegate.ImageDrawable drawable : drawables) {
