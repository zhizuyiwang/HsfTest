package com.hsf.hsftest.image.scalelayout;
...
import com.hsf.hsftest.BuildConfig;
...
public class ScaleLayout extends FrameLayout{
    ...
    protected void onFinishInflate() {
        ...
        if(mTopView != null){
            lp = (LayoutParams)mTopView.getLayoutParams();
        ...
        if(mBottomView != null){
            lp = (LayoutParams)mBottomView.getLayoutParams();
