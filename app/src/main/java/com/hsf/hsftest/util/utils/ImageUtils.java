...
public class ImageUtils {
    /**
     * @Description 根据InputStream获取图片实际的宽度和高度
     */
    ...
    /**
     * @Description 根据ImageView获适当的压缩的宽和高
     */
    ...
    /**
     * @Description 通过反射获取ImageView的某个属性值
     */
